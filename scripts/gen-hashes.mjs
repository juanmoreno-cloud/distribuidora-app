...
const USUARIOS = [
  ...
  ['VendedorR1_1', 'Vendedor 1 Ruta 1', 'vendedor', R1, 'Amazonas8B!V01', true],
  ['VendedorR1_2', 'Vendedor 2 Ruta 1', 'vendedor', R1, 'Everest8B!V02', true],
  ['VendedorR2_3', 'Vendedor 3 Ruta 2', 'vendedor', R2, 'Atlantis8B!V03', true],
  ['VendedorR2_4', 'Vendedor 4 Ruta 2', 'vendedor', R2, 'Catarata8B!V04', true],
  ['VendedorR3_5', 'Vendedor 5 Ruta 3', 'vendedor', R3, 'Diamante8B!V05', true],
  ['VendedorR3_6', 'Vendedor 6 Ruta 3', 'vendedor', R3, 'Elefante8B!V06', true],
  ['VendedorR1_7', 'Vendedor 7 Ruta 1', 'vendedor', R1, 'Fortaleza8B!V07', true],
  ['VendedorR2_8', 'Vendedor 8 Ruta 2', 'vendedor', R2, 'Galaxia8B!V08', true],
  ['VendedorR3_9', 'Vendedor 9 Ruta 3', 'vendedor', R3, 'Huracan8B!V09', true],
  ['VendedorR1_10', 'Vendedor 10 Ruta 1', 'vendedor', R1, 'Invierno8B!V10', true],
  ['Despachador1', 'Despachador 1', 'despachador', '', 'Jaguar8B!D01', true],
  ['Despachador2', 'Despachador 2', 'despachador', '', 'Karmico8B!D02', true],
  ['Despachador3', 'Despachador 3', 'despachador', '', 'Laberinto8B!D03', true],
  ['Despachador4', 'Despachador 4', 'despachador', '', 'Misterio8B!D04', true],
  ['Despachador5', 'Despachador 5', 'despachador', '', 'Nomada8B!D05', true],
  ['Almacenista1', 'Almacenista 1', 'almacenista', '', 'Olimpo8B!L01', true],
  ['Almacenista2', 'Almacenista 2', 'almacenista', '', 'Piramide8B!L02', true],
  ['Almacenista3', 'Almacenista 3', 'almacenista', '', 'Quetzal8B!L03', true],
  ['Almacenista4', 'Almacenista 4', 'almacenista', '', 'Relampago8B!L04', true],
  ['Almacenista5', 'Almacenista 5', 'almacenista', '', 'Sahara8B!L05', true],
];
