...
const COLOR_ROL: Record<Rol, string> = {
  ...
  lector: 'bg-gray-100 text-gray-700',
};
...
export default function UsuariosPage() {
  ...
  const soloLectura = esSoloLectura(yo?.rol ?? 'lector');
          ...
          <div key={u.id} className={`card p-3 ${u.activo ? '' : 'opacity-60'}`}>
            ...
            <div className="flex items-center justify-between mt-3">
              ...
              <button
                ...
                className={`relative w-12 h-6 rounded-full transition disabled:opacity-50 ${u.activo ? 'bg-green-500' : 'bg-gray-300'}`}
